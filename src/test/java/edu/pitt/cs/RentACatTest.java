...
public class RentACatTest {
	...
	public void testListCatsNumCats3() {
		...
		str = "ID " + c2.getId()+". "+c2.getName();
		Mockito.when(c2.toString()).thenReturn(str);
		str = "ID " + c3.getId()+". "+c3.getName();
		Mockito.when(c3.toString()).thenReturn(str);
		//String mycats = r.listCats();		
		//r.listCats();
		assertEquals("ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n", r.listCats());//r.listCats());
